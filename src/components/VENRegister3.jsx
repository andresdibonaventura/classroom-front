...
const price = () => {
  ...
  return (
    ...
    <a className='redirect' ref={redirectLink} href="https://buy.stripe.com/6oEeYxf8DdQccGA28e">Redireccionar</a>
...
export default RegisterThirdVEN