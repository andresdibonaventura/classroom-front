...
const price = () => {
  ...
  return (
    ...
    <button className='plan-button'> <a rel="stylesheet" href="https://buy.stripe.com/9AQ4jTaSn6nK7mg8wB">Pagar</a> 
    </button>
  </form>
  )
}

export default RegisterSecondVEN